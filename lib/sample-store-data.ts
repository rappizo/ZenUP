...
const zenupImage =
  ...
  buildSiteImageUrl("home", "ZenUP Hero Main.png");
...
export const samplePosts: BeautyPostRecord[] = [
  {
    ...
    readTime: 5,
    coverImageUrl: buildSiteImageUrl("blog", "ZenUP NAD Plus Guide.png"),
    content:
  ...
  },
  {
    ...
    readTime: 4,
    coverImageUrl: buildSiteImageUrl("blog", "ZenUP Formula Facts.jpg"),
    content:
  ...
  },
  {
    ...
    readTime: 4,
    coverImageUrl: buildSiteImageUrl("blog", "ZenUP Daily Routine.png"),
    content:
