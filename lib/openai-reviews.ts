          ...
          content: [
            {
              type: "input_text",
              text: [
                "You create internal review drafts for ecommerce moderation on a premium supplement store.",
                ...
                "Reviewer names must be full names only, with a first name and last name. Do not use initials or shortened surnames.",
                "Keep claims experience-based and non-medical. Avoid disease claims, diagnosis language, cure language, or guaranteed outcomes.",
                "Keep the reviews realistic, specific, and natural for a supplement product page."
              ].join(" ")
            }
          ]
        },
          ...
          content: [
            {
              ...
              text: [
                ...
                hasReferenceReviews
                  ...
                  : "No reference review file was uploaded for this run. Generate varied review voices directly from the product context instead of leaning on outside examples.\n",
                ...
                "- Keep the tone grounded in routine experience, ingredient confidence, convenience, packaging, serving size, and day-to-day consistency.",
