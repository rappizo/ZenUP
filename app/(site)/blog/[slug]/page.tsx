...
export async function generateMetadata({ params }: PostPageProps): Promise<Metadata> {
  ...
  return {
    ...
    keywords: [post.title, post.category, post.focusKeyword || "supplement guide", ...post.secondaryKeywords],
    openGraph: {
      type: "article",
        ...
        <div className="article-shell">
          ...
          {post.sourceProductSlug && post.sourceProductName ? (
            <div className="panel article-related-product">
              ...
              <p>
                Continue from this guide into the matching product page to see the ingredient
                profile, price, and routine fit for {post.sourceProductName}.
              </p>
