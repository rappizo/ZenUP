...
const posts = [
  {
    ...
    readTime: 6,
    coverImageUrl: buildSiteMediaUrl("blog", "cellular-energy-editorial.svg"),
    coverImageAlt:
    ...
    secondaryKeywords: ["nad plus routine", "healthy aging supplements", "daily energy support", "nicotinamide riboside guide"],
    imagePrompt:
  ...
  },
  {
    ...
    readTime: 7,
    coverImageUrl: buildSiteMediaUrl("blog", "nr-vs-nmn-editorial.svg"),
    coverImageAlt:
    ...
    secondaryKeywords: ["nad support options", "nr vs nmn comparison", "nicotinamide riboside supplement", "healthy aging routine"],
    imagePrompt:
  ...
  for (const post of posts) {
    await prisma.post.upsert({
      ...
      update: {
        ...
        externalLinks: JSON.stringify(Array.isArray(post.externalLinks) ? post.externalLinks : []),
        generatedAt: post.generatedAt || null,
