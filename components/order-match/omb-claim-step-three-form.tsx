...
export function OmbClaimStepThreeForm({
  ...
  destinationUrl,
  outboundButtonLabel,
  eyebrow = "OMB Claim / Final Step",
  title = "You are almost done. Finish the final step to complete your OMB claim.",
  description = `Copy your review text, post it on ${platformLabel}, then upload the proof and leave the shipping address for your extra bottle. Once this step is submitted, your claim is complete.`,
  ...
  addressLabel = "Leave the shipping address for your extra bottle",
  includeAddress = true
